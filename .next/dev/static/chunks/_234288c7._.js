...
"[project]/app/book-flight/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BookFlightPage() {
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "BookFlightPage.useSelector[user]": (state)=>state.user.user
    }["BookFlightPage.useSelector[user]"]);
    const dispatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDispatch"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BookFlightPage.useEffect": ()=>{
            const fetchFlights = {
                "BookFlightPage.useEffect.fetchFlights": async ()=>{
                    try {
                        ...
                        const selected = data.find({
                            "BookFlightPage.useEffect.fetchFlights.selected": (f)=>f._id === id || f.id === id
                        }["BookFlightPage.useEffect.fetchFlights.selected"]);
                        setFlight(selected);
                    } catch (error) {
            ...
            }["BookFlightPage.useEffect.fetchFlights"];
            fetchFlights();
        }
    }["BookFlightPage.useEffect"], [
        id
    ...
    const handleBooking = async ()=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleflightbooking"])(user?.id, flight.id, quantity, grandTotal);
            const updatedUser = {
                ...user,
                bookings: [
                    ...user.bookings,
...
_s(BookFlightPage, "R29GGyN1aDGCmniiYP+bRRMjPZE=", false, function() {
    return [
...
//# sourceMappingURL=_234288c7._.js.map